...
function UIView_ng_content_2_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵprojection(0, 0, ["*ngIf", "!_componentRef"]);
} }
/** @hidden */
var id = 0;
/**
...
var UIView = /** @class */ (function () {
    ...
    UIView.prototype._invokeUiOnParamsChangedHook = function ($transition$) {
        ...
        if (isFunction(uiOnParamsChanged)) {
            ...
            var fromSchema_1 = $transition$.treeChanges('from').map(getNodeSchema).reduce(unnestR, []);
    ...
    UIView.ɵfac = function UIView_Factory(t) { return new (t || UIView)(i0.ɵɵdirectiveInject(i1.UIRouter), i0.ɵɵdirectiveInject(UIView.PARENT_INJECT), i0.ɵɵdirectiveInject(i0.ViewContainerRef)); };
    UIView.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: UIView, selectors: [["ui-view"], ["", "ui-view", ""]], viewQuery: function UIView_Query(rf, ctx) { if (rf & 1) {
            i0.ɵɵviewQuery(_c0, 7, ViewContainerRef);
        } if (rf & 2) {
            var _t = void 0;
            i0.ɵɵqueryRefresh(_t = i0.ɵɵloadQuery()) && (ctx._componentTarget = _t.first);
        } }, inputs: { name: "name", _name: [0, "ui-view", "_name"] }, exportAs: ["uiView"], ngContentSelectors: _c1, decls: 3, vars: 1, consts: [["componentTarget", ""], [4, "ngIf"]], template: function UIView_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵprojectionDef();
            i0.ɵɵtemplate(0, UIView_ng_template_0_Template, 0, 0, "ng-template", null, 0, i0.ɵɵtemplateRefExtractor)(2, UIView_ng_content_2_Template, 1, 0, "ng-content", 1);
        } if (rf & 2) {
            i0.ɵɵadvance(2);
            i0.ɵɵproperty("ngIf", !ctx._componentRef);
        } }, dependencies: [i2.NgIf], encapsulation: 2 });
    return UIView;
}());
export { UIView };
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(UIView, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: i1.UIRouter }, { type: undefined, decorators: [{
                type: Inject,
                args: [UIView.PARENT_INJECT]
            }] }, { type: i0.ViewContainerRef }]; }, { _componentTarget: [{
            type: ViewChild,
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(UIView, { className: "UIView" }); })();
