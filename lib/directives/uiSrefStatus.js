...
var UISrefStatus = /** @class */ (function () {
    ...
    UISrefStatus.ɵfac = function UISrefStatus_Factory(t) { return new (t || UISrefStatus)(i0.ɵɵdirectiveInject(i1.UISref, 11), i0.ɵɵdirectiveInject(i2.UIRouterGlobals)); };
    UISrefStatus.ɵdir = /*@__PURE__*/ i0.ɵɵdefineDirective({ type: UISrefStatus, selectors: [["", "uiSrefStatus", ""], ["", "uiSrefActive", ""], ["", "uiSrefActiveEq", ""]], contentQueries: function UISrefStatus_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
            i0.ɵɵcontentQuery(dirIndex, UISref, 5);
        } if (rf & 2) {
            var _t = void 0;
            i0.ɵɵqueryRefresh(_t = i0.ɵɵloadQuery()) && (ctx._srefs = _t);
        } }, outputs: { uiSrefStatus: "uiSrefStatus" }, exportAs: ["uiSrefStatus"] });
    return UISrefStatus;
}());
export { UISrefStatus };
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(UISrefStatus, [{
        type: Directive,
        args: [{
                selector: '[uiSrefStatus],[uiSrefActive],[uiSrefActiveEq]',
                exportAs: 'uiSrefStatus',
            }]
    }], function () { return [{ type: i1.UISref, decorators: [{
                type: Host
            }, {
                type: Self
            }, {
                type: Optional
            }] }, { type: i2.UIRouterGlobals }]; }, { uiSrefStatus: [{
            type: Output,
            args: ['uiSrefStatus']
        }], _srefs: [{
